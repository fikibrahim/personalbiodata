...
function controlSlide(element) {
    ...
    changSlide(currentSlide)
}

function changSlide(currentSlide) {
    controlButton = document.querySelector(".slide-controls").children;
...
function autoPlay() {
    // console.log("call");
    if (autoSlide == slideDots.length - 1) {
        autoSlide = 0;
    } else {
        autoSlide++;
    }
    changSlide(autoSlide)
}
